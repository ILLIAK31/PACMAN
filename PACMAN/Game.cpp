...
Game::Game(Menu menu):Window(sf::VideoMode(CELL*Width*Screen, CELL*Height*Screen*1.2), "Pacman"),matrix(Width, std::vector<std::string>(Height)),pacman(matrix)
{
	...
	matrix[9][37] = matrix[9][36] = matrix[9][35] = matrix[9][34] = matrix[9][33] = matrix[10][37] = matrix[10][33] = matrix[11][37] = matrix[11][36] = matrix[11][35] = matrix[11][34] = matrix[11][33] = "#";
	...
	matrix[9][29] = matrix[9][28] = matrix[9][27] = matrix[9][26] = matrix[9][25] = matrix[10][25] = matrix[10][29] = matrix[11][29] = matrix[11][28] = matrix[11][27] = matrix[11][26] = matrix[11][25] = "#";

	matrix[15][4] = matrix[15][5] = matrix[15][6] = matrix[15][7] = matrix[15][8] = matrix[16][4] = matrix[16][5] = matrix[16][6] = matrix[16][7] = matrix[16][8] = "#";
	matrix[15][37] = matrix[15][36] = matrix[15][35] = matrix[15][34] = matrix[15][33] = matrix[16][37] = matrix[16][36] = matrix[16][35] = matrix[16][34] = matrix[16][33] = "#";


	matrix[20][1] = matrix[20][2] = matrix[20][3] = matrix[20][4] = matrix[20][5] = matrix[20][6] = matrix[20][7] = matrix[20][8] = "#";
	matrix[20][41] = matrix[20][40] = matrix[20][39] = matrix[20][38] = matrix[20][37] = matrix[20][36] = matrix[20][35] = matrix[20][34] = matrix[20][33] = "#";

	matrix[24][1] = matrix[24][2] = matrix[24][3] = matrix[24][4] = matrix[24][5] = matrix[24][6] = matrix[24][7] = matrix[24][8] = "#";
	matrix[24][41] = matrix[24][40] = matrix[24][39] = matrix[24][38] = matrix[24][37] = matrix[24][36] = matrix[24][35] = matrix[24][34] = matrix[24][33] = "#";


	matrix[21][0] = matrix[22][0] = matrix[23][0] = matrix[21][41] = matrix[22][41] = matrix[23][41] = "";

	matrix[31][1] = matrix[31][2] = matrix[32][1] = matrix[32][2] = matrix[31][3] = matrix[32][3] = matrix[31][4] = matrix[32][4] = "#";
	matrix[31][40] = matrix[31][39] = matrix[31][38] = matrix[31][37] = matrix[32][40] = matrix[32][39] = matrix[32][38] = matrix[32][37] = "#";
