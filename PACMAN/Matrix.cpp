...
void Matrix::Setup_Matrix(std::vector<std::vector<std::string>>& matrix)
{
	...
	matrix[6][21] = "#13";
	matrix[20][7] = matrix[24][7] = matrix[32][3] = matrix[28][37] = matrix[36][16] = matrix[36][37] = "#14";
	matrix[20][34] = matrix[24][34] = matrix[32][38] = matrix[36][4] = matrix[36][25] = matrix[28][4] = "#15";
	matrix[32][0] = "#16";
	matrix[32][41] = "#17";
